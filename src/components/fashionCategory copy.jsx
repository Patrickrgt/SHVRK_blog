    ...
    return (
      <React.Fragment className="body-color">
        ...
        <div id="blog-tab-div">
          <button
            className={
              this.state.fashion === true ? "blog-tab blog-active" : "blog-tab"
            }
          ...
          <button
            className={
              this.state.art === true ? "blog-tab blog-active" : "blog-tab"
            }
            onClick={(tab) => this.artCategory(tab)}
          >
            art
          </button>
          <button
            className={
              this.state.music === true ? "blog-tab blog-active" : "blog-tab"
            }
          ...
          <button
            className={
              this.state.social === true ? "blog-tab blog-active" : "blog-tab"
            }
          ...
          <button
            className={
              this.state.gaming === true ? "blog-tab blog-active" : "blog-tab"
            }
